...
En este caso aunque $f_a$ esté cerca de $f_s$ sigue estando en la zona de Nyquist sin existir aliasing, además no hay inversión de fase. Por esto es que se sigue viendo fiel a la señal original, ademas tenemos una buena cantidad de muestras.
El espectro se nota un poco más allá de 800Hz debido a la señal original, ademas sin ruido no existe distorsión.
